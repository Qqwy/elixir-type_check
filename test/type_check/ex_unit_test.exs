defmodule TypeCheck.ExUnitTest do
  ...
  describe "spectest uses `:except` option correctly" do
    ...
    spectest SpectestTestExample, except: [mischievous_mannequin: 0, raising_raptor: 0, picky_pineapple: 1]
  end
  ...
  describe "spectest uses `:initial_seed` option correctly" do
    seed = 42
    spectest SpectestTestExample, only: [picky_pineapple: 1], initial_seed: seed, generator: {StreamData, [max_runs: 1]}
  end
end
